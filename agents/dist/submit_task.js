...
function selectAgents(stepCount) {
...
function calculatePayouts(totalBountyEth, steps) {
...
function calculateInsurance(totalBounty) {
...
async function submitTask(taskName) {
    ...
    try {
        const tx = await solace.createPipeline(pipelineId, deadline, taskConfig.type, taskConfig.min_score, ethers.ZeroHash, // No parent pipeline
        0, // No parent step
        agents, payouts, dependencies, { value: totalValue });
...
//# sourceMappingURL=submit_task.js.map