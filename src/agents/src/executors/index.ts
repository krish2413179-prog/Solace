...
register("static_analysis", async (wallet, input) =>
  (await callOGCompute(
    wallet,
...
register("business_logic_audit", async (wallet, input) =>
  (await callOGCompute(
    wallet,
...
register("gas_optimization", async (wallet, input) =>
  (await callOGCompute(
    wallet,
...
register("test_coverage_analysis", async (wallet, input) =>
  (await callOGCompute(
    wallet,
...
register("tokenomics_analysis", async (wallet, input) =>
  (await callOGCompute(
    wallet,
...
register("defi_risk_analysis", async (wallet, input) =>
  (await callOGCompute(
    wallet,
...
register("code_review", async (wallet, input) =>
  (await callOGCompute(
    wallet,
...
register("liquidity_analysis", async (wallet, input) =>
  (await callOGCompute(
    wallet,
